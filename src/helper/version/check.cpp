...
std::optional<Audiopad::Objects::VersionStatus> VersionCheck::getStatus()
{
    auto githubTags = client.Get("/repos/audiopadapp/audiopad/tags");
        ...
        if (!parsed.is_discarded())
        {
            ...
            if (!latestTag.is_null())
            {
                ...
                try
                {
                    ...
                    auto local = semver::from_string(AUDIOPAD_VERSION);
