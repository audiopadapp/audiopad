...
For more examples see [`examples`](https://github.com/audiopadapp/webviewpp/tree/master/examples) 

## Embedding
webviewpp supports embedding of all required files.  
To embed your files you have to use the [embed-helper](https://github.com/audiopadapp/webviewpp/tree/master/embed-helper).
...
> For an example see [examples/embedded](https://github.com/audiopadapp/webviewpp/tree/master/examples/embedded)
