...
#define MyAppName "Audiopad"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Audiopad"
#define MyAppURL "https://audiopad.vercel.app/"
#define MyAppExeName "audiopad.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{4c1c8c0a-b413-40b1-99d9-4575660dde11}
AppName={#MyAppName}
...
[Files]
Source: "..\..\build\Release\audiopad.exe"; DestDir: "{app}"; Flags: ignoreversion
